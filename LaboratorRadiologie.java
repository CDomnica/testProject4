...
public class LaboratorRadiologie extends JPanel {
	...
	public LaboratorRadiologie() {
		...
		btnNewButton_Tiparire.setBounds(627, 302, 187, 23);
		...
		btnNewButton_Raportare.setBounds(610, 112, 185, 59);
		...
		btnNewButton_Cauta.setBounds(336, 180, 89, 23);
		add(btnNewButton_Cauta);
		fillComboBoxDoctor();
