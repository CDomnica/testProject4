...
public class Receptie extends JPanel {
	...
	public Receptie() {
		...
		txtNume.setBounds(99, 51, 248, 20);
		panel.add(txtNume);
		...
		textPrenume.setBounds(128, 89, 219, 20);
		...
		textCNP.setBounds(99, 132, 248, 20);
		panel.add(textCNP);
		...
		btnNewButton_RaportProgramari.setBounds(329, 364, 169, 25);
		panel.add(btnNewButton_RaportProgramari);
		
		JScrollPane scrollPane = new JScrollPane(table);
		scrollPane.setBounds(34, 400, 745, 139);
		...
		textCautaCNP.setBounds(111, 330, 125, 20);
		...
		btnNewButton_StergeProgramare.setBounds(604, 573, 175, 23);
		...
		btnNewButton_Clear.setBounds(43, 550, 140, 23);
		...
		btnNewButton.setBounds(246, 329, 89, 23);
